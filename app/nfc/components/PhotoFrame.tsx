// app/nfc-redirect/components/PhotoFrame.tsx
"use client";
...
export default function PhotoFrame({ photoUrl, name, title, theme }: PhotoFrameProps) {
  const hasPhoto = photoUrl && photoUrl !== '/placeholder-image.jpg';
  ...
  return (
    <div className="relative w-full max-w-4xl">
      ...
      <motion.div
        ...
        className="relative rounded-3xl p-3 bg-gradient-to-br from-purple-500 via-pink-500 to-blue-500 animate-gradient-x"
      >
          ...
          <div className="relative w-full aspect-[3/4] rounded-xl overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
              ...
              >
                ...
                <p className="text-purple-300 text-lg">{title}</p>
      ...
      {Array.from({ length: 4 }).map((_, i) => (
        <motion.div
          key={i}
          className="absolute w-4 h-4 rounded-full bg-gradient-to-r from-cyan-400 to-blue-400"
          animate={{
            scale: [1, 1.5, 1],
            rotate: [0, 180, 360],
          }}
